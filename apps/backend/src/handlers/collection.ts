...
export const postCollectionEntryHandler: RouteHandler<
  typeof postCollectionEntryRoute,
  Env
> = async (c) => {
...
export const getCollectionEntriesHandler: RouteHandler<
  typeof getCollectionEntriesRoute,
  Env
> = async (c) => {
  const userId = requireAuth(c)
...
export const deleteCollectionEntryHandler: RouteHandler<
  typeof deleteCollectionEntryRoute,
  Env
> = async (c) => {
  const userId = requireAuth(c)
